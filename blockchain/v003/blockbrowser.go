...
func (bb *BlockBrowser) handleIndex(w http.ResponseWriter, r *http.Request) {
	content := "<html><br>"
	content +=  "<b>&nbsp;&nbsp;&nbsp;&nbsp;MiniBC区块链区块浏览器</b><br><br>"
	content +=  "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"shutdown\">关闭MiniBC</a>"
	content +=  "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"getblocks\">查看区块链</a>&nbsp;&nbsp;&nbsp;&nbsp;"
	content +=  "</html>"
	w.Write([]byte(content))
}
//处理Url为 http://SERVER_ADDR:8080/shutdown 的请求，关闭区块链浏览器，退出系统
func (bb *BlockBrowser) handleShutdown(w http.ResponseWriter, r *http.Request) {
	fmt.Println("")
	fmt.Println("")
	fmt.Println("=========================================================================")
...
func (bb *BlockBrowser) handleGetBlocks(w http.ResponseWriter, r *http.Request) {
	//获取区块链高度
